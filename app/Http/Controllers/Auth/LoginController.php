...
class LoginController extends Controller {
	...
	*/
	...
	public function callback( $service ) {
		...
		$user = Socialite::with( $service )->fields([
			'first_name', 'last_name', 'email', 'sex', 'bdate', 'city', 'photo_max_orig'
		])->user();
	...
	public function findOrCreateUser( $user, $service ) {
		...
		$authUser = SocialLogin::where('provider', $service )->where('provider_id', $user->id )->first();
//dd($authUser);
